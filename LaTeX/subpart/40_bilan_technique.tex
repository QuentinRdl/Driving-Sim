...
En commançant notre projet, nous avons voulu implémenter trop de principes physiques en m�me temps, ce qui nous menait à de nombreuses erreurs.
...
C'est en adoptant une manière itérative, en implémentant les différents phénomènes physique un à un, que nous avons réussi à avoir un modèle physique fonctionnel.
...
Par exemple, il a été difficile de trouver
