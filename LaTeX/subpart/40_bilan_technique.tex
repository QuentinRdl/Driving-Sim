...
\begin{itemize}
    ...
    \item \texttt{\glspl{cmake}} (version 3.30 ou supérieure) : pour la configuration et la gestion de la compilation.
    ...
    \item \texttt{\gls{boost}} : utilisé pour la manipulation des flux, notamment en lien avec \texttt{gnuplot}.
