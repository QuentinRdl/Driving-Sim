...
Elle initialise la fenêtre \gls{sfml}, configure les \glspl{view} (Game \glslink{view}{View} et \gls{hud} \glslink{view}{View}), gère le cycle de vie de la simulation (mise à jour, gestion des événements et rendu) et coordonne les interactions entre les différents modules.
...
\begin{itemize}
    ...
    \item \textbf{\gls{hud} \glslink{view}{View}} : Cette \gls{view} affiche des informations supplémentaires, telles que le compteur de FPS et les données de débogage.
\end{itemize}
