...
\newglossaryentry{view}{ % TODO METTRE DANS DRIVING_SIM_REPORT.tex
    name=vue,
    plural=vues,
    description={Vue, en anglais. Dans le contexte de l'interface graphique, cela fait référence à la manière dont les éléments sont affichés à l'utilisateur.}
}
