...
\begin{itemize}
    ...
    Cette trajectoire, rendue à l'aide d'un \texttt{sf::VertexArray}, permet à l'utilisateur de visualiser l'impact des commandes de conduite sur le comportement futur du véhicule.
\end{itemize}
...
Cette classe contient un attribut \texttt{std::vector<sf::Text>} qui contient les textes à afficher dans la HUD View.
