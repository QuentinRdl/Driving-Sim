...
L'extrait de code suivant permet de réaliser ce bout de circuit~\ref{fig:example_circuit_1} :
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{/home/rgld_/01-dev-projects/cpp-projects/Driving-Sim/LaTeX/figures/example_circuit_1.png} % TODO FIX PATH
