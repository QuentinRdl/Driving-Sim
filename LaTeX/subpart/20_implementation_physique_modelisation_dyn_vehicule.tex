\section{L'implémentation de la physique / Modélisation d'un système de \gls{dynamique_vehicule}}\label{sec:l'implementation-de-la-physique-/-modelisation-d'un-systeme-de-dynamique-de-vehicule}
