...
De plus, pour lancer la génération de tracés des différentes données de notre implémentation, il faut lancer l'exécutable \texttt{src/build/}, ce qui générera les graphiques du scénario qui est décrit dans le fichier \texttt{XXXXXXXX}.
% TODO : REMPLACER EXE