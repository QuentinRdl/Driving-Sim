...
Celle-ci s'étend sur une durée de 10 secondes (avec un pas de 0,1 s), et avons utilisé \textbf{\glspl{gnuplot}} pour visualiser les résultats obtenus et observer si le résultat obtenu est celui attendu.
