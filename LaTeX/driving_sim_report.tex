...
\newglossaryentry{saturation_forces_laterales}{
    ...
    first={saturation non linéaire des forces latérales}
}
...
%    \glsaddall
    ...
    \begin{thebibliography}{9}
        ...
        ``\texttt{std::\gls{deque}::push\_back} - Documentation non-officielle \gls{cpp}''. \\
        Disponible sur : \url{https://en.cppreference.com/w/cpp/container/deque/push_back}.

        \bibitem{cpp_reference_pop_front}
        Contributeurs de cppreference.com.\\
        ``\texttt{std::\gls{deque}::pop\_front} - Documentation non-officielle \gls{cpp}''.\\
