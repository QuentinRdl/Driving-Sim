...
\newglossaryentry{opengl}{
    name={OpenGL},
    description={Bibliothèque de rendu graphique 2D et 3D, utilisée par \gls{sfml} pour le rendu graphique},
    first={OpenGL\textsuperscript{*}}
}

\newglossaryentry{hud}{
    name={HUD},
    description={\og\textit{Heads Up Display}\fg{} en anglais, un système d’affichage superposé sur l’écran, utilisé ici pour présenter des informations telles que le compteur de \gls{fps} et les données de débogage},
...
\newglossaryentry{stl}{
    ...
    description={\og \textit{Standard Template Library} \fg{}, bibliothèque standard de \gls{cpp} fournissant des conteneurs, algorithmes et itérateurs},
...
\newglossaryentry{git_branches}{
    name={branche},
    plural={branches},
    description={Branche de développement dans \gls{git}, permettant de travailler sur différentes fonctionnalités ou corrections de \textit{bugs} sans affecter la branche principale},
}
...
\newglossaryentry{googletest}{
    name={GoogleTest},
    description={\textit{Framework} de test unitaire pour \gls{cpp}, utilisé pour écrire et exécuter des tests automatisés},
    first={GoogleTest\textsuperscript{*}},
}

\newglossaryentry{view}{
    name={vue},
    plural={vues},
    description={\textit{View}, en anglais. Dans le contexte de l'interface graphique, cela fait référence à la manière dont les éléments sont affichés à l'utilisateur},
}

\newglossaryentry{multi_threading}{
    name={Multi-threading},
    description={Technique de programmation permettant l'exécution concurrente de plusieurs \textit{threads} (unités d'exécution) au sein d'un même processus, améliorant ainsi la réactivité et la performance des applications},
    first={Multi-threading\textsuperscript{*}},
}

\newglossaryentry{fps}{
    name={FPS},
    description={\og \textit{Frames Per Second} \fg{}, mesure du nombre d'images affichées par seconde dans une animation ou un jeu vidéo, indiquant la fluidité de l'affichage},
...
\newglossaryentry{github}{
    name={GitHub},
    description={Plateforme de développement collaboratif fondée sur \gls{git}, permettant de gérer des projets, de suivre les modifications et de collaborer avec d'autres développeurs},
...
\newglossaryentry{csharp} {
    name={C\#},
    description={Langage de programmation orienté-objet développé par Microsoft, utilisé pour le développement d'applications sur la plateforme \og .NET \fg{}},
    first={C\#\textsuperscript{*}},
}
